...
@serving
def ask(query: str, DB_URI: str, **kwargs) -> str:
  try:
...
if(__name__ == "__main__"):
  print(ask("how many instances are running in the region us-east-1", "postgresql://postgres:YQwoegl8YOk4k6Drym3748zzy11g@lookover-ai-test-1.cf3alghuei5c.ap-south-1.rds.amazonaws.com:5432/postgres"))